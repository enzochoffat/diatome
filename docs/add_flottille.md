...
9. Dans `src/core/config.py`, ajouter les constantes et mettre à jour `get_fisher_config()` et `validate_config()`
...
15. Dans `src/interfaces/cli/report.py`, ajouter dans les rapports
16. Dans `src/interfaces/gui/gui.py` (si utilisée), ajouter les contrôles UI
